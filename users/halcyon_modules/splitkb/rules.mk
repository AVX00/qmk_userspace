...
ifdef CUSTOM_DISPLAY
  include $(USER_PATH)/splitkb/custom_display/rules.mk
endif

ifdef CUSTOM_TRACKPAD
  include $(USER_PATH)/splitkb/custom_trackpad/rules.mk
endif
...
HLC_OPTIONS := $(HLC_NONE) $(HLC_CIRQUE_TRACKPAD) $(HLC_ENCODER) $(HLC_TFT_DISPLAY) $(CUSTOM_DISPLAY)
